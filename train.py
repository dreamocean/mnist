...
if __name__ == '__main__':
    ...
    parser.add_argument('--network', type=str, help='the neural network to use')
    parser.add_argument('--gpus', type=str, default ='0', help='list of gpus to run, e.g. 0 or 0,2,5. empty means using cpu')
